...
const Avatar = ({ name }) => {
  ...
  return (
    <div
      className="w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0 text-xs font-700 text-white"
...
const AdminPayments = () => {
  ...
  const STAT_CARDS = [
    ...
    },
    {
      ...
      sub:
        stats?.commissionRate != null ? `${stats.commissionRate}% rate` : "—",
      accent: "#059669",
      icon: (
        <span
          style={{
