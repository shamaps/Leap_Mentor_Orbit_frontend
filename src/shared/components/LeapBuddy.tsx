...
import { sendAiChatMessage } from "@/shared/api/ai.api";
...
export default function LeapBuddy({
  ...
  const [ticketForms, setTicketForms] = useState<Record<number, { email: string; subject: string; message: string }>>({});
  ...
  const submitTicket = async (idx: number) => {
    ...
    try {
      await submitSupportMessage({ ...form, role });
        ...
        >
          ...
          >
            ...
            {messages.map((msg, idx) => {
              ...
              const msgIdx = msg.msgIdx ?? -1;
              const tStatus = ticketStatus[msgIdx];
              return (
                <div
                        ...
                        <>
                          ...
                          >
                            <input
                              ...
                              value={ticketForms[msgIdx]?.email || ""}
                              onChange={(e) =>
                                setTicketForms((p) => ({
                                  ...p,
                                  [msgIdx]: {
                            ...
                            <input
                              placeholder="Subject"
                              value={ticketForms[msgIdx]?.subject || ""}
                              onChange={(e) =>
                                setTicketForms((p) => ({
                                  ...p,
                                  [msgIdx]: {
                            ...
                            <textarea
                              ...
                              value={ticketForms[msgIdx]?.message || ""}
                              onChange={(e) =>
                                setTicketForms((p) => ({
                                  ...p,
                                  [msgIdx]: {
