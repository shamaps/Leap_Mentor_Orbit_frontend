...
const isOverdue = (dueDate?: string | null): boolean => Boolean(dueDate) && new Date(dueDate as string) < new Date();
...
const MilestoneList = ({
  ...
  saving?: boolean;
  onAdd: (goalId: string, data: { title: string }) => Promise<{ success?: boolean } | void>;
  onToggle: (id: string, isCompleted: boolean) => void;
