...
import DashboardTopbar from "@/shared/components/DashboardTopbar.jsx";
...
const MentorConnectsTab = lazy(() => import("@/features/connects/view/MentorConnectsTab"));
const NotificationsTab = lazy(() => import("@/features/notifications/view/NotificationsTabMentor"));
const TrackEarningsTab = lazy(() => import("./earnings/TrackEarningsTab"));
const HelpCenter = lazy(() => import("@/shared/components/HelpCenter"));
