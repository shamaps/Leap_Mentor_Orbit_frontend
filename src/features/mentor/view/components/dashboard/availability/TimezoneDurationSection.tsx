// components/mentor/dashboard/availability/TimezoneDurationSection.tsx
import { SESSION_DURATION_OPTIONS } from "@/features/mentor/model/availability.types";
import type { SessionDuration } from "@/features/mentor/model/availability.types";
          ...
          {SESSION_DURATION_OPTIONS.map((duration) => {
            ...
            return (
              <button
                ...
                className={`px-4 py-2 rounded-xl text-xs font-bold transition-all duration-150 ${isSelected
