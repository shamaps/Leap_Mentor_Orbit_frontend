// src/features/admin/view/pages/AdminLogin.jsx
/* eslint-disable react-hooks/refs -- emailField/passwordField are react-hook-form register() results;
   their `.ref` property is a callback ref prop, not a React ref read during render. */
import { useAdminLogin } from "../../presenter/useAdminLogin";
