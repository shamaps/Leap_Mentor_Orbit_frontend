// src/features/admin/view/pages/AdminSettings.jsx
import { useAdminSettings } from "../../presenter/useAdminSettings";
...
const SubmitBtn = ({ loading, label, onClick, accent = "#2563eb" }: { loading: boolean; label: string; onClick: () => void; accent?: string }) => (
  <button
    type="button"
    onClick={onClick}
    disabled={loading}
