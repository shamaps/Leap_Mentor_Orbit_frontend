...
const SocialPresenceCard = ({ profile }: SocialPresenceCardProps) => {
  const linkedInUrl = profile?.linkedInUrl as string | undefined;
  const portfolioUrl = profile?.portfolioUrl as string | undefined;
  return (
