...
const Field = ({ label, icon, value }: FieldProps) => (
...
const ProfessionalDetailsCard = ({ profile }: ProfessionalDetailsCardProps) => {
  const currentRole = profile?.currentRole as string | undefined;
  const yearsOfExperience = profile?.yearsOfExperience as string | number | undefined;
