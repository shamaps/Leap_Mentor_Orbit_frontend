// src/components/ui/connects/ConnectCard.tsx
...
const formatSlot = (slot?: ConnectSlot | null) => {
  if (!slot) return null;
...
const Avatar = ({ name, picture, isCompleted }: AvatarProps) => {
  if (picture) {
    return (
      <img
        src={picture}
