...
const LoginForm = ({ placeholder, registerPath }: LoginFormProps) => {
  ...
  const dispatchDashboardRedirection = (assignedRoles: string[]) => {
  ...
  const handlePostAuth = (_token: string | undefined, user: { roles?: string[] } | null | undefined) => {
  ...
  return (
    <div className="w-full max-w-sm mx-auto px-4">
      ...
      <div className="flex items-center gap-3 my-6">
        ...
        <span className="text-xs text-slate-700 font-medium">Or continue with</span>
        <div className="h-px bg-slate-200 flex-1" />
      </div>
