...
const STEPS = { EMAIL: 1, OTP: 2, PASSWORD: 3 } as const;
...
const ACCESS_SECURITY_POLICIES: SecurityPolicy[] = [
...
const computeSecurityLevelScore = (targetVal: string) => {
...
const grabVisualBarAttributes = (pointsScored: number) => {
  const levels = [
...
const ForgotPassword = () => {
  ...
  const handleOtpChange = (valueString: string, index: number) => {
  ...
  const getStepDotClass = (s: number, step: number) => {
