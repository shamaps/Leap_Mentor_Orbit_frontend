...
const parseSessionSlotDate = (sessionSlot) => {
...
// ── Alternative Badge Specification Registry ──────────────────
const MENTOR_ACHIEVEMENT_BADGES = [
  { idCode: "newcomer", labelTitle: "Newcomer", glyph: "👋", description: "Joined LeapMentor", validator: () => true },
  { idCode: "ten_sessions", labelTitle: "10 Sessions", glyph: "🎯", description: "Completed 10 sessions", validator: (p) => (p?.totalSessions || 0) >= 10 },
  { idCode: "top_rated", labelTitle: "Top Rated", glyph: "⭐", description: "Achieved 4.5+ rating", validator: (p) => (p?.avgRating || 0) >= 4.5 },
  { idCode: "expert_guide", labelTitle: "Expert Guide", glyph: "🏆", description: "50+ sessions completed", validator: (p) => (p?.totalSessions || 0) >= 50 }
];
  ...
  return (
    <div className="space-y-5">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
        ...
        <StatCard variant="home" label="Avg Rating" value={profile?.avgRating > 0 ? profile.avgRating.toFixed(1) : "New"} sub={profile?.avgRating > 0 ? "out of 5.0" : "no reviews yet"} icon={<IconStar />} />
