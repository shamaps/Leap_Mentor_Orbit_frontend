  ...
  if (hasSearched && mentors.length === 0) {
    return (
      <EmptyState
        ...
        subMessage="Try a different skill or adjust your filters"
      />
    );
  }
    ...
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <p className="text-xs text-slate-400 mt-1.5 max-w-xs leading-relaxed">
          Type a skill above — like{" "}
          <span className="font-semibold text-slate-500">React</span>,{" "}
          <span className="font-semibold text-slate-500">Python</span>, or{" "}
          <span className="font-semibold text-slate-500">Design</span> — to
          discover mentors who can help you grow.
        </p>
      </div>
    );
  }
