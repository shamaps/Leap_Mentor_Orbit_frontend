...
const SlotPill = ({ slot, group, onToggle, isBooked }) => {
  return (
    ...
    >
      <span
        className={`text-[11px] font-bold leading-tight ${isBooked ? "text-slate-300" : "text-slate-700"}`}
      >
    ...
    g.slots.some(
      (s) =>
        !existingSlotDates.some(
          (e) => e.date === g.date && e.startTime === s.startTime,
        ),
    ),
  );
        ...
        <>
          ...
          <div>
            ...
            <p className="text-sm  text-blue-900  mt-0.5">
              Schedule a new session with your {isMentor ? "mentee" : "mentor"}
            </p>
          </div>
          {/* ── Two column layout ── */}
                      ...
                      {availableGroups.map((group, idx) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              {
                                (group.displayDate || group.day || "").split(
                                  ",",
                                )[0]
                              }
                            </span>
                      ...
                      <div>
                        <div className="flex items-center justify-between mb-2.5">
                          ...
                          <span className="text-[10px] text-slate-400 font-medium">
                            {
                              activeGroup.slots.filter(
                                (s) =>
                                  !isSlotBooked(activeGroup.date, s.startTime),
                              ).length
                            }{" "}
                            open
                          </span>
